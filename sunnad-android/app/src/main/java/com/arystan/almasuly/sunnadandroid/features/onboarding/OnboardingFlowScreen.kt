...
fun OnboardingFlowScreen(
    ...
    val templates = listOf(
        ...
        OnboardingTemplateSeed("five_times_prayer", stringResource(R.string.onboarding_template_five_times_prayer), stringResource(R.string.onboarding_category_spiritual), Icons.Rounded.SelfImprovement, HabitIconKey.PRAYER, HabitCategoryValue.SPIRITUAL),
        OnboardingTemplateSeed("fajr_prayer", stringResource(R.string.onboarding_template_fajr), stringResource(R.string.onboarding_category_spiritual), Icons.Rounded.SelfImprovement, HabitIconKey.PRAYER, HabitCategoryValue.SPIRITUAL),
        OnboardingTemplateSeed("dhuhr_prayer", stringResource(R.string.onboarding_template_dhuhr), stringResource(R.string.onboarding_category_spiritual), Icons.Rounded.SelfImprovement, HabitIconKey.PRAYER, HabitCategoryValue.SPIRITUAL),
        OnboardingTemplateSeed("asr_prayer", stringResource(R.string.onboarding_template_asr), stringResource(R.string.onboarding_category_spiritual), Icons.Rounded.SelfImprovement, HabitIconKey.PRAYER, HabitCategoryValue.SPIRITUAL),
        OnboardingTemplateSeed("maghrib_prayer", stringResource(R.string.onboarding_template_maghrib), stringResource(R.string.onboarding_category_spiritual), Icons.Rounded.SelfImprovement, HabitIconKey.PRAYER, HabitCategoryValue.SPIRITUAL),
        OnboardingTemplateSeed("isha_prayer", stringResource(R.string.onboarding_template_isha), stringResource(R.string.onboarding_category_spiritual), Icons.Rounded.SelfImprovement, HabitIconKey.PRAYER, HabitCategoryValue.SPIRITUAL),
