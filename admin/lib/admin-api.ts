...
type QuoteMutationInput = {
  status: QuoteStatus;
  translations: Array<
    Pick<QuoteTranslation, "locale" | "text" | "source" | "active" | "draft">
  >;
};

export async function listQuoteSets(
  params: AuthHeaderParams,
): Promise<QuoteCollectionResponse> {
  return request<QuoteCollectionResponse>(
    "GET",
    "/admin-quotes/quotes",
    params,
  );
...
export async function createQuoteSet(
  params: AuthHeaderParams,
...
export async function updateQuoteSet(
  params: AuthHeaderParams,
  setID: string,
  input: QuoteMutationInput,
): Promise<void> {
...
export async function approveQuoteSet(
  params: AuthHeaderParams,
  setID: string,
): Promise<void> {
...
export async function deleteQuoteSet(
  params: AuthHeaderParams,
  setID: string,
): Promise<void> {
...
export async function verifyQuoteSource(
  ...
  return request<VerifySourceResponse>(
    "POST",
    "/admin-quotes/quotes/verify-source",
    params,
    payload,
  );
}

export async function pinQuoteDay(
  params: AuthHeaderParams,
  day: string,
  quoteSetID: string,
): Promise<void> {
...
export async function unpinQuoteDay(
  params: AuthHeaderParams,
  day: string,
): Promise<void> {
